...
public class Relatorios extends JDialog {
	...
	public Relatorios() {
		...
		btnClientes.setIcon(new ImageIcon(Relatorios.class.getResource("/img/client_report.png")));
		btnClientes.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				relatorioClientes();
			}
		});
		btnClientes.setBounds(29, 37, 128, 128);
		...
		btnOsPendentes.setIcon(new ImageIcon(Relatorios.class.getResource("/img/pendentes_report.png")));
		...
		btnOsPendentes.setBounds(201, 37, 128, 128);
		...
		btnOsConcluidas.setIcon(new ImageIcon(Relatorios.class.getResource("/img/concluido_report.png")));
		...
		btnOsConcluidas.setBounds(29, 221, 128, 128);
		...
		lblNewLabel.setBounds(29, 171, 128, 23);
		...
		lblOsPendentes.setFont(new Font("Verdana", Font.BOLD, 14));
		lblOsPendentes.setBounds(201, 171, 128, 23);
		...
		lblOsConcludas.setFont(new Font("Verdana", Font.BOLD, 14));
		lblOsConcludas.setBounds(29, 355, 128, 23);
		...
		btnNewButton.setIcon(new ImageIcon(Relatorios.class.getResource("/img/orcamento_report.png")));
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				relatorioOrcamento();
			}
		});
		btnNewButton.setBounds(201, 221, 128, 128);
