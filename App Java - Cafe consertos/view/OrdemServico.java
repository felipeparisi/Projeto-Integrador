...
public class OrdemServico extends JDialog {
	...
	public OrdemServico() {
		...
		lblNewLabel.setBounds(17, 15, 120, 14);
		...
		scrollPane.setBounds(17, 43, 539, 62);
		...
		txtNomeCli.setBounds(130, 12, 225, 20);
		...
		lblNewLabel_1.setBounds(195, 195, 92, 14);
		getContentPane().add(lblNewLabel_1);

		txtEndereco = new JTextField();
		txtEndereco.setEditable(false);
		txtEndereco.setBounds(282, 193, 274, 20);
		...
		lblNewLabel_2.setBounds(574, 195, 70, 14);
		getContentPane().add(lblNewLabel_2);

		txtNumero = new JTextField();
		txtNumero.setEditable(false);
		txtNumero.setBounds(641, 193, 109, 20);
		...
		lblNewLabel_3.setBounds(17, 226, 109, 14);
		getContentPane().add(lblNewLabel_3);

		txtComplemento = new JTextField();
		txtComplemento.setEditable(false);
		txtComplemento.setBounds(122, 224, 262, 20);
		...
		lblNewLabel_4.setBounds(17, 153, 77, 14);
		getContentPane().add(lblNewLabel_4);

		txtIdUser = new JTextField();
		txtIdUser.setEnabled(false);
		txtIdUser.setBounds(98, 151, 70, 20);
		...
		lblNewLabel_5.setBounds(554, 266, 77, 14);
		getContentPane().add(lblNewLabel_5);

		txtProtocolo = new JTextField();
		txtProtocolo.setEditable(false);
		txtProtocolo.setBounds(632, 264, 118, 20);
		...
		lblNewLabel_6.setBounds(17, 298, 231, 14);
		getContentPane().add(lblNewLabel_6);

		txtTipoEquipamento = new JTextField();
		txtTipoEquipamento.setEnabled(false);
		txtTipoEquipamento.setBounds(227, 296, 523, 20);
		...
		lblNewLabel_8.setBounds(17, 266, 70, 14);
		...
		cboStatus.setBounds(84, 263, 300, 20);
		...
		lblNewLabel_9.setBounds(20, 335, 348, 14);
		...
		lblNewLabel_11.setBounds(468, 15, 33, 14);
		getContentPane().add(lblNewLabel_11);

		txtIdCli = new JTextField();
		txtIdCli.setEditable(false);
		txtIdCli.setBounds(497, 13, 59, 20);
		...
		btnCriarOs.setIcon(new ImageIcon(OrdemServico.class.getResource("/img/add_button.png")));
		...
		btnCriarOs.setBounds(84, 498, 82, 82);
		getContentPane().add(btnCriarOs);

		btnNewButton_4 = new JButton("");
		btnNewButton_4.setContentAreaFilled(false);
		btnNewButton_4.setBorderPainted(false);
		btnNewButton_4.setIcon(new ImageIcon(OrdemServico.class.getResource("/img/clear_button.png")));
		...
		btnNewButton_4.setBounds(468, 498, 82, 82);
		...
		btnBuscarCli.setBounds(365, -2, 48, 48);
		...
		lblNewLabel_12.setBounds(401, 335, 349, 13);
		getContentPane().add(lblNewLabel_12);

		btnImprimir = new JButton("");
		btnImprimir.setIcon(new ImageIcon(OrdemServico.class.getResource("/img/printer_report.png")));
		...
		btnImprimir.setBounds(273, 498, 82, 82);
		getContentPane().add(btnImprimir);

		JLabel lblNewLabel_13 = new JLabel("*Valor a ser Pago:");
		lblNewLabel_13.setForeground(new Color(0, 51, 102));
		lblNewLabel_13.setFont(new Font("Verdana", Font.BOLD, 12));
		lblNewLabel_13.setBounds(17, 455, 133, 13);
		...
		cboStatusPagamento.setBounds(570, 452, 179, 21);
		getContentPane().add(cboStatusPagamento);

		txtBairro = new JTextField();
		txtBairro.setEditable(false);
		txtBairro.setBounds(471, 224, 279, 20);
		getContentPane().add(txtBairro);
		txtBairro.setColumns(10);

		txtCep = new JTextField();
		txtCep.setEditable(false);
		txtCep.setBounds(60, 194, 117, 20);
		getContentPane().add(txtCep);
		txtCep.setColumns(10);

		JLabel lblNewLabel_15 = new JLabel("CEP:");
		lblNewLabel_15.setForeground(new Color(0, 51, 102));
		lblNewLabel_15.setFont(new Font("Verdana", Font.BOLD, 12));
		lblNewLabel_15.setBounds(17, 197, 45, 13);
		getContentPane().add(lblNewLabel_15);

		JLabel lblNewLabel_16 = new JLabel("Bairro:");
		lblNewLabel_16.setForeground(new Color(0, 51, 102));
		lblNewLabel_16.setFont(new Font("Verdana", Font.BOLD, 12));
		lblNewLabel_16.setBounds(412, 227, 59, 13);
		...
		lblNewLabel_7.setBounds(600, 15, 150, 150);
		...
		btnDeletar.setIcon(new ImageIcon(OrdemServico.class.getResource("/img/delete_button.png")));
		btnDeletar.setToolTipText("Deletar");
		btnDeletar.setEnabled(false);
		btnDeletar.setContentAreaFilled(false);
		btnDeletar.setBorderPainted(false);
		btnDeletar.setBounds(641, 498, 82, 82);
