...
public class Usuarios extends JDialog {
	...
	public Usuarios() {
		...
		txtNome.setBounds(87, 33, 453, 20);
		...
		lblTelefone.setBounds(23, 255, 76, 14);
		...
		txtTelefone.setBounds(109, 253, 226, 20);
		...
		lblLogin.setBounds(23, 303, 69, 14);
		...
		txtLogin.setBounds(87, 301, 248, 20);
		...
		cboPerfil.setBounds(87, 387, 248, 20);
		...
		btnPesquisar.setBounds(209, 188, 48, 48);
		...
		scrollPane.setBounds(87, 61, 463, 113);
		...
		lblId.setBounds(31, 207, 46, 14);
		getContentPane().add(lblId);

		txtId = new JTextField();
		txtId.setEditable(false);
		txtId.setBounds(63, 205, 136, 20);
		...
		btnAtualizar.setIcon(new ImageIcon(Usuarios.class.getResource("/img/update_button.png")));
		...
		btnAtualizar.setBounds(46, 451, 82, 82);
		...
		btnDeletar.setIcon(new ImageIcon(Usuarios.class.getResource("/img/delete_button.png")));
		...
		btnDeletar.setBounds(171, 451, 82, 82);
		...
		btnAdicionar.setIcon(new ImageIcon(Usuarios.class.getResource("/img/add_button.png")));
		...
		btnAdicionar.setBounds(290, 451, 82, 82);
		...
		txtSenha.setBounds(87, 340, 248, 20);
		...
		chckSenha.setBounds(353, 339, 110, 23);
		getContentPane().add(chckSenha);

		JButton btnLimpar = new JButton("");
		btnLimpar.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		btnLimpar.setIcon(new ImageIcon(Usuarios.class.getResource("/img/clear_button.png")));
		...
		btnLimpar.setBounds(458, 451, 110, 110);
		...
		lblNewLabel.setBounds(560, 110, 200, 320);
