...
public class Clientes extends JDialog {
	...
	public Clientes() {
		...
		txtNome.setBounds(94, 27, 289, 25);
		getContentPane().add(txtNome);
		txtNome.setColumns(10);

		scrollPane = new JScrollPane();
		scrollPane.setBounds(94, 79, 652, 115);
		...
		btnBuscarId.setBounds(561, 12, 48, 48);
		...
		lblEndereco.setBounds(23, 273, 95, 14);
		...
		txtEndereco.setBounds(119, 268, 627, 25);
		...
		lblNumero.setBounds(24, 310, 94, 20);
		...
		txtNumero.setBounds(119, 305, 162, 25);
		...
		lblComplemento.setBounds(299, 305, 141, 20);
		...
		txtComplemento.setBounds(464, 305, 282, 25);
		...
		lblEmail.setBounds(35, 463, 83, 20);
		...
		txtEmail.setBounds(119, 458, 627, 25);
		...
		lblTelefone.setBounds(23, 394, 110, 41);
		...
		txtTelefone.setBounds(119, 402, 264, 25);
		...
		btnAdicionar.setIcon(new ImageIcon(Clientes.class.getResource("/img/add_button2.png")));
		...
		btnAdicionar.setBounds(60, 562, 110, 110);
		getContentPane().add(btnAdicionar);

		btnExcluir = new JButton("");
		btnExcluir.setContentAreaFilled(false);
		btnExcluir.setBorderPainted(false);
		btnExcluir.setIcon(new ImageIcon(Clientes.class.getResource("/img/delete_button2.png")));
		...
		btnExcluir.setBounds(406, 562, 110, 110);
		getContentPane().add(btnExcluir);

		btnAlterar = new JButton("");
		btnAlterar.setContentAreaFilled(false);
		btnAlterar.setBorderPainted(false);
		btnAlterar.setIcon(new ImageIcon(Clientes.class.getResource("/img/update_button2.png")));
		...
		btnAlterar.setBounds(225, 562, 110, 110);
		getContentPane().add(btnAlterar);

		btnLimpar = new JButton("");
		btnLimpar.setContentAreaFilled(false);
		btnLimpar.setBorderPainted(false);
		btnLimpar.setIcon(new ImageIcon(Clientes.class.getResource("/img/clear_button2.png")));
		...
		btnLimpar.setBounds(589, 562, 110, 110);
		...
		lblNewLabel.setBounds(24, 228, 77, 26);
		...
		txtCep.setBounds(119, 229, 219, 25);
		...
		btnPesquisarCep.setBounds(375, 206, 48, 48);
		...
		lblNewLabel_1.setBounds(360, 353, 80, 13);
		...
		txtCidade.setBounds(464, 347, 282, 25);
		...
		lblNewLabel_3.setBounds(902, 212, 200, 320);
